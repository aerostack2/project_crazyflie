...
new_window 'behaviors' "ros2 launch as2_behaviors_motion follow_reference_behavior_launch.py \
    namespace:=$drone_namespace \
    use_sim_time:=$use_sim_time "
    
new_window 'add_object' "ros2 launch as2_external_object_to_tf as2_external_object_to_tf_launch.py \
    namespace:=$drone_namespace \
    config_file:=config/external_objects.json "
